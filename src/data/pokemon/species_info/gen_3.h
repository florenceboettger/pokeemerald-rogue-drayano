...
#ifdef ROGUE_DRAYANO
    #define ZIGZAGOON_ATTACK 40
#else
    #define ZIGZAGOON_ATTACK 30
#endif

#if P_FAMILY_ZIGZAGOON
#define ZIGZAGOON_MISC_INFO                                                     \
        .baseHP        = 38,                                                    \
        .baseAttack    = ZIGZAGOON_ATTACK,                                      \
        .baseDefense   = 41,                                                    \
        .baseSpeed     = 60,                                                    \
        .baseSpAttack  = 30,                                                    \
        .baseSpDefense = 41,                                                    \
...
#ifdef ROGUE_DRAYANO
    #define LINOONE_HP 85
    #define LINOONE_ATTACK 85
    #define LINOONE_DEFENSE 60
    #define LINOONE_SPEED 110
    #define LINOONE_SPDEFENSE 60
#else
    #define LINOONE_HP 78
    #define LINOONE_ATTACK 70
    #define LINOONE_DEFENSE 61
    #define LINOONE_SPEED 100
    #define LINOONE_SPDEFENSE 61
#endif

#define LINOONE_MISC_INFO                                                       \
        .baseHP        = LINOONE_HP,                                            \
        .baseAttack    = LINOONE_ATTACK,                                        \
        .baseDefense   = LINOONE_DEFENSE,                                       \
        .baseSpeed     = LINOONE_SPEED,                                         \
        .baseSpAttack  = 50,                                                    \
        .baseSpDefense = LINOONE_SPDEFENSE,                                     \
        .catchRate = 90,                                                        \
        .expYield = 147,                                                        \
        .evYield_Speed = 2,                                                     \
        .genderRatio = PERCENT_FEMALE(50),                                      \
...
#ifdef ROGUE_DRAYANO
    #define CASTFORM_HP 60
    #define CASTFORM_ATTACK 60
    #define CASTFORM_DEFENSE 60
    #define CASTFORM_SPEED 95
    #define CASTFORM_SPATTACK 105
#else
    #define CASTFORM_HP 70
    #define CASTFORM_ATTACK 70
    #define CASTFORM_DEFENSE 70
    #define CASTFORM_SPEED 70
    #define CASTFORM_SPATTACK 70
#endif

#define CASTFORM_MISC_INFO                                      \
        .baseHP        = CASTFORM_HP,                           \
        .baseAttack    = CASTFORM_ATTACK,                       \
        .baseDefense   = CASTFORM_DEFENSE,                      \
        .baseSpeed     = CASTFORM_SPEED,                        \
        .baseSpAttack  = CASTFORM_SPATTACK,                     \
        .baseSpDefense = 70,                                    \
        .catchRate = 45,                                        \
        .expYield = 147,                                        \
        .evYield_HP = 1,                                        \
...
#ifdef ROGUE_DRAYANO
    #define SHUPPET_LINE_TYPE { TYPE_GHOST, TYPE_NORMAL }
#else
    #define SHUPPET_LINE_TYPE { TYPE_GHOST, TYPE_GHOST }
#endif
