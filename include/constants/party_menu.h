...
#define AILMENT_FNT   7
    ...
    #define TUTOR_MOVE_POWER_UP_PUNCH   103
    #define TUTOR_MOVE_POWER_WHIP       104
    #define TUTOR_MOVE_PSYCHIC_FANGS    105
    #define TUTOR_MOVE_PSYCHO_CUT       106
    #define TUTOR_MOVE_PSYSHOCK         107
    #define TUTOR_MOVE_RISING_VOLTAGE   108
    #define TUTOR_MOVE_ROCK_CLIMB       109
    #define TUTOR_MOVE_ROOST            110
    #define TUTOR_MOVE_SCALD            111
    #define TUTOR_MOVE_SCALE_SHOT       112
    #define TUTOR_MOVE_SCORCHING_SANDS  113
    #define TUTOR_MOVE_SEED_BOMB        114
    #define TUTOR_MOVE_SHADOW_CLAW      115
    #define TUTOR_MOVE_SIGNAL_BEAM      116
    #define TUTOR_MOVE_SKITTER_SMACK    117
    #define TUTOR_MOVE_SLUDGE_WAVE      118
    #define TUTOR_MOVE_SMART_STRIKE     119
    #define TUTOR_MOVE_SNARL            120
    #define TUTOR_MOVE_SPIKES           121
    #define TUTOR_MOVE_STEALTH_ROCK     122
    #define TUTOR_MOVE_STEEL_ROLLER     123
    #define TUTOR_MOVE_STOMPING_TANTRUM 124
    #define TUTOR_MOVE_STONE_EDGE       125
    #define TUTOR_MOVE_SUPERPOWER       126
    #define TUTOR_MOVE_SYNTHESIS        127
    #define TUTOR_MOVE_TAIL_SLAP        128
    #define TUTOR_MOVE_GRASSY_TERRAIN   129
    #define TUTOR_MOVE_MISTY_TERRAIN    130
    #define TUTOR_MOVE_ELECTRIC_TERRAIN 131
    #define TUTOR_MOVE_PSYCHIC_TERRAIN  132
    #define TUTOR_MOVE_TERRAIN_PULSE    133
    #define TUTOR_MOVE_THROAT_CHOP      134
    #define TUTOR_MOVE_TRI_ATTACK       135
    #define TUTOR_MOVE_TRICK            136
    #define TUTOR_MOVE_TRICK_ROOM       137
    #define TUTOR_MOVE_TRIPLE_AXEL      138
    #define TUTOR_MOVE_U_TURN           139
    #define TUTOR_MOVE_VACUUM_WAVE      140
    #define TUTOR_MOVE_VENOM_DRENCH     141
    #define TUTOR_MOVE_VENOSHOCK        142
    #define TUTOR_MOVE_VOLT_SWITCH      143
    #define TUTOR_MOVE_WEATHER_BALL     144
    #define TUTOR_MOVE_WHIRLPOOL        145
    #define TUTOR_MOVE_WILD_CHARGE      146
    #define TUTOR_MOVE_WILL_O_WISP      147
    #define TUTOR_MOVE_WORK_UP          148
    #define TUTOR_MOVE_X_SCISSOR        149
    #define TUTOR_MOVE_ZEN_HEADBUTT     150
    #define TUTOR_MOVE_COUNT            151
#else
