...
#define AILMENT_FNT   7
    ...
    #define TUTOR_MOVE_FLARE_BLITZ      67
    #define TUTOR_MOVE_FLASH_CANNON     68
    #define TUTOR_MOVE_FLING            69
    #define TUTOR_MOVE_FLIP_TURN        70
    #define TUTOR_MOVE_FOUL_PLAY        71
    #define TUTOR_MOVE_FROST_BREATH     72
    #define TUTOR_MOVE_GIGA_IMPACT      73
    #define TUTOR_MOVE_GRASSY_GLIDE     74
    #define TUTOR_MOVE_HEAL_BELL        75
    #define TUTOR_MOVE_HEAT_CRASH       76
    #define TUTOR_MOVE_HEAT_WAVE        77
    #define TUTOR_MOVE_HELPING_HAND     78
    #define TUTOR_MOVE_HEX              79
    #define TUTOR_MOVE_HIGH_HORSEPOWER  80
    #define TUTOR_MOVE_HONE_CLAWS       81
    #define TUTOR_MOVE_HURRICANE        82
    #define TUTOR_MOVE_HYPER_VOICE      83
    #define TUTOR_MOVE_ICICLE_SPEAR     84
    #define TUTOR_MOVE_IRON_DEFENSE     85
    #define TUTOR_MOVE_IRON_HEAD        86
    #define TUTOR_MOVE_KNOCK_OFF        87
    #define TUTOR_MOVE_LASH_OUT         88
    #define TUTOR_MOVE_LEAF_STORM       89
    #define TUTOR_MOVE_LEECH_LIFE       90
    #define TUTOR_MOVE_LIQUIDATION      91
    #define TUTOR_MOVE_LOW_SWEEP        92
    #define TUTOR_MOVE_METEOR_BEAM      93
    #define TUTOR_MOVE_MISTY_EXPLOSION  94
    #define TUTOR_MOVE_MYSTICAL_FIRE    95
    #define TUTOR_MOVE_NASTY_PLOT       96
    #define TUTOR_MOVE_PHANTOM_FORCE    97
    #define TUTOR_MOVE_POLTERGEIST      98
    #define TUTOR_MOVE_OUTRAGE          99
    #define TUTOR_MOVE_PLAY_ROUGH       100
    #define TUTOR_MOVE_POISON_JAB       101
    #define TUTOR_MOVE_POLLEN_PUFF      102
    #define TUTOR_MOVE_POWER_GEM        103
    #define TUTOR_MOVE_POWER_UP_PUNCH   104
    #define TUTOR_MOVE_POWER_WHIP       105
    #define TUTOR_MOVE_PSYCHIC_FANGS    106
    #define TUTOR_MOVE_PSYCHO_CUT       107
    #define TUTOR_MOVE_PSYSHOCK         108
    #define TUTOR_MOVE_RISING_VOLTAGE   109
    #define TUTOR_MOVE_ROCK_CLIMB       110
    #define TUTOR_MOVE_ROOST            111
    #define TUTOR_MOVE_SCALD            112
    #define TUTOR_MOVE_SCALE_SHOT       113
    #define TUTOR_MOVE_SCORCHING_SANDS  114
    #define TUTOR_MOVE_SEED_BOMB        115
    #define TUTOR_MOVE_SHADOW_CLAW      116
    #define TUTOR_MOVE_SIGNAL_BEAM      117
    #define TUTOR_MOVE_SKITTER_SMACK    118
    #define TUTOR_MOVE_SLUDGE_WAVE      119
    #define TUTOR_MOVE_SMART_STRIKE     120
    #define TUTOR_MOVE_SNARL            121
    #define TUTOR_MOVE_SPIKES           122
    #define TUTOR_MOVE_STEALTH_ROCK     123
    #define TUTOR_MOVE_STEEL_ROLLER     124
    #define TUTOR_MOVE_STOMPING_TANTRUM 125
    #define TUTOR_MOVE_STONE_EDGE       126
    #define TUTOR_MOVE_SUPERPOWER       127
    #define TUTOR_MOVE_SYNTHESIS        128
    #define TUTOR_MOVE_TAIL_SLAP        129
    #define TUTOR_MOVE_GRASSY_TERRAIN   130
    #define TUTOR_MOVE_MISTY_TERRAIN    131
    #define TUTOR_MOVE_ELECTRIC_TERRAIN 132
    #define TUTOR_MOVE_PSYCHIC_TERRAIN  133
    #define TUTOR_MOVE_TERRAIN_PULSE    134
    #define TUTOR_MOVE_THROAT_CHOP      135
    #define TUTOR_MOVE_TRI_ATTACK       136
    #define TUTOR_MOVE_TRICK            137
    #define TUTOR_MOVE_TRICK_ROOM       138
    #define TUTOR_MOVE_TRIPLE_AXEL      139
    #define TUTOR_MOVE_U_TURN           140
    #define TUTOR_MOVE_VACUUM_WAVE      141
    #define TUTOR_MOVE_VENOM_DRENCH     142
    #define TUTOR_MOVE_VENOSHOCK        143
    #define TUTOR_MOVE_VOLT_SWITCH      144
    #define TUTOR_MOVE_WEATHER_BALL     145
    #define TUTOR_MOVE_WHIRLPOOL        146
    #define TUTOR_MOVE_WILD_CHARGE      147
    #define TUTOR_MOVE_WILL_O_WISP      148
    #define TUTOR_MOVE_WORK_UP          149
    #define TUTOR_MOVE_X_SCISSOR        150
    #define TUTOR_MOVE_ZEN_HEADBUTT     151
    #define TUTOR_MOVE_COUNT            152
#else
